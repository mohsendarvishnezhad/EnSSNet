...
SP-EnSSNet-RF with Backward Feature Selection:
...
def build_sparse_knn_adj_tensor(features, k=13):
    """
...
class EnSSNetWithGCNModel(nn.Module):
    def __init__(self, gcn_in_channels, gcn_out_channels, patch_size, k_neighbors=13):
        super().__init__()
