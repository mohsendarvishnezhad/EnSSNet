...
MP-EnSSNet-RF with Forward Feature Selection:
...
def forward_rollback_with_test_mi(X_train, y_train, X_test, y_test):
    ...
    ranked = list(np.argsort(-mi))  # descending
...
# Example usage (you should call this with your own data split):
# selected_features, log = forward_rollback_with_test_mi(X_train, y_train, X_test, y_test)
